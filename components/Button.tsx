...
export default function Button(
    ...
    if (border) {
        button_final_class += "border-blue-400 border-[1px] ";
    } else if (gray) {
        button_final_class += "bg-gray-900 ";
    } else {
        button_final_class += "bg-blue-400 ";
    }

    button_final_class += "text-blue-50 p-2 inline-flex items-center rounded-md text-center hover:no-underline duration-200 "
    ...
    if (disabled) {
        ...
        if (border) {
            button_final_class += "hover:bg-blue-400 ";
        } else if (gray) {
            button_final_class += "hover:bg-gray-700 ";
        } else {
            button_final_class += "hover:bg-blue-600 ";
        }
    }
